  ...
  return (
    <>
      <Grid container component="main" className={classes.root}>
        {
          countriesData && countriesData.map(({ name, capital, latlng, population, flag }) => (
            <Grid item xs={12} sm={6} md={4} className={classes.login} square>
                <Card className={classes.root} variant="outlined">
                  ...
                  <CardActions>
                    <Button size="small" onClick={() => handler(capital)} >Capital Weather</Button>
                  </CardActions>
                </Card>
            </Grid>
          ))
              ...
              <DialogContent dividers>
                {
                  isLoading
                    ...
                    : <>
                        <CardMedia
                          className={classes.media}
                          image={weatherData.weather_icons[0]}
                        />
                        <Typography gutterBottom>
                          Country Name : {weatherData.country}
                        </Typography>
                        <Typography gutterBottom>
